...
|---|------|------|--------|------------|
| 1 | Install Dependencies & Initialize shadcn/ui | [task-1](task-1-install-dependencies.md) | not_started | — |
| 2 | Types, Constants & Hardcoded Server Data | [task-2](task-2-database-setup.md) | not_started | Task 1 |
